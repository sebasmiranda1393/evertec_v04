        ...
        <div class="row justify-content">
            ...
            @can('reports')
                ...
                <div class="m-2">
                    <div class="card">
                        <div class="col m-1">
                            <a href="{{ route('exportProductsStocks') }}" class="btn btn-primary "> Exportar productos
                                excel</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="m-2">
                    <div class="card">
                        <div class="col m-1">
                            <a href="{{ route('excel.index') }}" class="btn btn-primary "> importar todos los
                                productos </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="m-2">
                    <form action="{{ route('reportByDateTopSellingProduct')}}" enctype="multipart/form-data"
                          method="POST">
                        {{csrf_field()}}
                        <div class="card">
                            <div class="col m-1">
                        ...
                        <div class="card">
                            <div class="col m-1">
                                ...
                                <input id="cantidad" name="cantidad" type="number" required
                                       autocomplete="top __ con mayor stock:">
                                <input type="submit" class=" btn btn-primary" value="Descargar"/>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card">
                    <div class="col m-2">
                        <form action="{{ route('stockProducts')}}" enctype="multipart/form-data" method="POST">
                            ...
                            <br/>
                            <br/>
                            <input onchange="myFunction(this)" type="checkbox" name="mayor" id="mayor" value=1>stock de
                            productos con __ o mas unidades <br/>
                            <input onchange="myFunction(this)" type="checkbox" name="menor" id="menor" value=2>stock de
                            productos con __ o menos unidades
                            <br/>
                            <input type="submit" class=" btn btn-primary" value="Descargar"/>
                        </form>
                    </div>
